...
tipo: divindade
status: rascunho
referência: Lua rubra / senhora dos vampiros (Hécate sombria)
panteão: "[[Deidades Transversais]]"
domínios: [criaturas noturnas, vampiros, transformação, instinto]
aliases: ["Selene", "A Lua Rubra", "A Mãe das Feras Noturnas"]
tags: [divindade, lua]
---
#### Domínios
As criaturas da noite, os vampiros, a transformação e os instintos que a civilização tenta esconder.
...
- [[Cosmos & Fé/Religiões/Divindades/Luna]] — irmã-rival: o instinto contra o acalanto.
- [[Solarion]] e [[Valder]] — inimigos naturais: o sol e o descanso honrado contra os mortos que não descansam.

---
#### Ganchos de expansão
%% A ligação entre os ciclos de Selene e as ondas de atividade vampírica. %%
